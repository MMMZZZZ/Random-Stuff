...
SHAMD5IntHandler(void)
{
    ...
    {
        MAP_SHAMD5IntClear(SHAMD5_BASE, SHAMD5_INT_DMA_CONTEXT_IN);
    ...
    {
        MAP_SHAMD5IntClear(SHAMD5_BASE, SHAMD5_INT_DMA_DATA_IN);
    ...
    {
        MAP_SHAMD5IntClear(SHAMD5_BASE, SHAMD5_INT_DMA_CONTEXT_OUT);
                 ...
                 bool bUseDMA, bool bPreProcessedKey)
{
    ...
    if(bPreProcessedKey)
    {
        MAP_SHAMD5HMACPPKeySet(SHAMD5_BASE, pui32HMACKey);
    }
    else
    {
        MAP_SHAMD5HMACKeySet(SHAMD5_BASE, pui32HMACKey);
    }
    ...
    if(bUseDMA)
    {
        ...
        //
        MAP_SHAMD5IntEnable(SHAMD5_BASE, (SHAMD5_INT_DMA_CONTEXT_IN |
        ...
        if(ui32DataLength != 0)
        {
            ...
            //
            MAP_uDMAChannelAssign(UDMA_CH5_SHAMD50DIN);
            MAP_uDMAChannelAttributeDisable(UDMA_CH5_SHAMD50DIN,
                                            UDMA_ATTR_ALTSELECT |
                                            UDMA_ATTR_USEBURST |
                                            UDMA_ATTR_HIGH_PRIORITY |
                                            UDMA_ATTR_REQMASK);
            MAP_uDMAChannelControlSet(UDMA_CH5_SHAMD50DIN | UDMA_PRI_SELECT,
                                      UDMA_SIZE_32 | UDMA_SRC_INC_32 |
                                      UDMA_DST_INC_NONE | UDMA_ARB_16 |
                                      UDMA_DST_PROT_PRIV);
            MAP_uDMAChannelTransferSet(UDMA_CH5_SHAMD50DIN | UDMA_PRI_SELECT,
                                       UDMA_MODE_BASIC, (void *)pui32Data,
                                       (void *)(SHAMD5_BASE +
                                                SHAMD5_O_DATA_0_IN),
                                       ui32DataLength / 4);
            MAP_uDMAChannelEnable(UDMA_CH5_SHAMD50DIN);
        ...
        //
        MAP_uDMAChannelAssign(UDMA_CH6_SHAMD50COUT);
        MAP_uDMAChannelAttributeDisable(UDMA_CH6_SHAMD50COUT,
                                        UDMA_ATTR_ALTSELECT |
                                        UDMA_ATTR_USEBURST |
                                        UDMA_ATTR_HIGH_PRIORITY |
                                        UDMA_ATTR_REQMASK);
        MAP_uDMAChannelControlSet(UDMA_CH6_SHAMD50COUT | UDMA_PRI_SELECT,
                                  UDMA_SIZE_32 | UDMA_SRC_INC_32 |
                                  UDMA_DST_INC_32 | UDMA_ARB_8 |
                                  UDMA_SRC_PROT_PRIV);
        MAP_uDMAChannelTransferSet(UDMA_CH6_SHAMD50COUT | UDMA_PRI_SELECT,
                                   UDMA_MODE_BASIC,
                                   (void *)(SHAMD5_BASE + SHAMD5_O_IDIGEST_A),
                                   (void *)pui32HMACResult, 5);
        MAP_uDMAChannelEnable(UDMA_CH6_SHAMD50COUT);
        UARTprintf("Context out DMA request enabled.\n");

        //
        // Enable DMA in the SHA/MD5 module.
        //
        MAP_SHAMD5DMAEnable(SHAMD5_BASE);

        //
        // Write the length.
        //
        MAP_SHAMD5HashLengthSet(SHAMD5_BASE, ui32DataLength);
        ...
        //
        MAP_SHAMD5DMADisable(SHAMD5_BASE);
    }
    ...
    else
    {
        ...
        //
        MAP_SHAMD5HMACProcess(SHAMD5_BASE, pui32Data, ui32DataLength,
                              pui32HMACResult);
    }
}
...
main(void)
{
    ...
    MAP_SHAMD5Reset(SHAMD5_BASE);
    MAP_SHAMD5ConfigSet(SHAMD5_BASE, SHAMD5_ALGO_HMAC_SHA1);
    MAP_SHAMD5HMACPPKeyGenerate(SHAMD5_BASE, g_pui32SHA1HMACKey,
                                pui32HMACPPKey);
