                 ...
                 uint32_t ui32Length)
{
    ...
    //
    MAP_AESConfigSet(AES_BASE, (AES_CFG_KEY_SIZE_128BIT | AES_CFG_DIR_ENCRYPT |
                                AES_CFG_MODE_ECB));

    //
    // Write the key.
    //
    MAP_AESKey1Set(AES_BASE, pui32Key, AES_CFG_KEY_SIZE_128BIT);
            ...
            uint32_t ui32IVLength, uint32_t *pui32Result)
{
    ...
    // Configure the AES module.
    //
    MAP_AESConfigSet(AES_BASE, (AES_CFG_KEY_SIZE_128BIT |
                                AES_CFG_MODE_GCM_HLY0ZERO));

    //
    // Set the hash subkey.
    //
    MAP_AESKey2Set(AES_BASE, pui32HashSubkey, AES_CFG_KEY_SIZE_128BIT);

    //
    // Write the lengths
    //
    MAP_AESLengthSet(AES_BASE, (uint64_t)ui32IVLength);
    MAP_AESAuthLengthSet(AES_BASE, 0);
    ...
    for(ui32Count = 0; ui32Count < ui32IVLength; ui32Count += 16)
    {
        ...
        //
        MAP_AESDataWrite(AES_BASE, pui32IV + (ui32Count / 4));
    }
                 ...
                 uint32_t ui32AADLength, uint32_t *pui32Tag, bool bUseDMA)
{
    ...
    // Configure the AES module.
    //
    MAP_AESConfigSet(AES_BASE, (AES_CFG_KEY_SIZE_128BIT | AES_CFG_DIR_DECRYPT |
    ...
    if(bUseDMA)
    {
        ...
        //
        MAP_AESAuthLengthSet(AES_BASE, ui32AADLength);
    ...
    else
    {
        ...
        //
        MAP_AESDataProcessAuth(AES_BASE, pui32Src, pui32Dst, ui32Length,
