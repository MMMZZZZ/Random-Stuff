               ...
               uint32_t ui32Length, bool bUseDMA)
{
    ...
    //
    MAP_AESKey2Set(AES_BASE, pui32Subkey1, AES_CFG_KEY_SIZE_128BIT);

    //
    // Write the second subkey.
    //
    MAP_AESKey3Set(AES_BASE, pui32Subkey2);

    //
    // Write the IV with zeroes.
    //
    MAP_AESIVSet(AES_BASE, pui32Zero);
    ...
    if(bUseDMA)
    {
        ...
        // Enable DMA requests
        //
        MAP_AESDMAEnable(AES_BASE, AES_DMA_DATA_IN);
        ...
        // Read out the tag.
        //
        MAP_AESTagRead(AES_BASE, pui32Tag);
    }
    else
    {
        //
        ...
        //
        MAP_AESDataAuth(AES_BASE, pui32Src, ui32Length, pui32Tag);
    }
