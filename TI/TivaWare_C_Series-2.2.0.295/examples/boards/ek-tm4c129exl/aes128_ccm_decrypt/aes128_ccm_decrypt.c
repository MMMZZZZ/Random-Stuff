                 ...
                 uint32_t ui32TagLength, bool bUseDMA)
{
    ...
    if(bUseDMA)
    {
        ...
        //
        MAP_AESLengthSet(AES_BASE, (uint64_t)ui32DataLength);

        //
        // Write the auth length registers to start the process.
        //
        MAP_AESAuthLengthSet(AES_BASE, ui32AuthDataLength);
    ...
    else
    {
        ...
        //
        MAP_AESDataProcessAuth(AES_BASE, pui32Src, pui32Dst, ui32DataLength,
