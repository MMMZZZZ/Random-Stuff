...
main(void)
{
    ...
    //
    MAP_GPIOPinTypeGPIOOutput(GPIO_PORTQ_BASE, (USER_LED1|USER_LED2));
    ...
    while(1)
    {
        ...
        // Turn on the LED
        //
        MAP_GPIOPinWrite(GPIO_PORTQ_BASE, (USER_LED1|USER_LED2), USER_LED1);
        ...
        // Turn on the LED
        //
        MAP_GPIOPinWrite(GPIO_PORTQ_BASE, (USER_LED1|USER_LED2), USER_LED2);
