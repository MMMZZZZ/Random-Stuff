...
SetLineCoding(tLineCoding *psLineCoding, uint32_t ui32UARTClock)
{
    ...
    //
    MAP_UARTConfigSetExpClk(UART0_BASE, ui32UARTClock,
...
GetLineCoding(tLineCoding *psLineCoding, uint32_t ui32UARTClock)
{
    ...
    //
    MAP_UARTConfigGetExpClk(UART0_BASE, ui32UARTClock, &ui32Rate,
                            &ui32Config);
...
main(void)
{
    ...
    //
    MAP_UARTConfigSetExpClk(UART0_BASE, UART_CLOCK,
    ...
    //
    MAP_UARTIntClear(UART0_BASE, MAP_UARTIntStatus(UART0_BASE, false));
    MAP_UARTIntEnable(UART0_BASE, (UART_INT_OE | UART_INT_BE | UART_INT_PE |
