...
UART0IntHandler(void)
{
    ...
    // control structure.
    //
    ui32Mode = MAP_uDMAChannelModeGet(UDMA_CHANNEL_UART0RX | UDMA_ALT_SELECT);
    ...
    if(ui32Mode == UDMA_MODE_STOP)
    {
        ...
        // reused.
        //
        MAP_uDMAChannelTransferSet(UDMA_CHANNEL_UART0RX | UDMA_ALT_SELECT,
                                   UDMA_MODE_PINGPONG,
                                   (void *)(UART0_BASE + UART_O_DR),
    ...
    // is done.
    //
    if(!MAP_uDMAChannelIsEnabled(UDMA_CHANNEL_UART0TX))
    {
        //
...
InitUART0Transfer(void)
{
    ...
    MAP_UARTDMAEnable(UART0_BASE, UART_DMA_RX | UART_DMA_TX);
    ...
    //
    MAP_uDMAChannelControlSet(UDMA_CHANNEL_UART0RX | UDMA_PRI_SELECT,
    ...
    //
    MAP_uDMAChannelControlSet(UDMA_CHANNEL_UART0RX | UDMA_ALT_SELECT,
                              UDMA_SIZE_8 | UDMA_SRC_INC_NONE | UDMA_DST_INC_8 |
                              UDMA_ARB_4);
    ...
    //
    MAP_UARTIntEnable(UART0_BASE, UART_INT_DMATX | UART_INT_DMATX);
