...
main(void)
{
    ...
    MAP_GPIOIntTypeSet(GPIO_PORTH_BASE, GPIO_PIN_2, GPIO_FALLING_EDGE);
    ...
    MAP_SysCtlPeripheralSleepEnable(SYSCTL_PERIPH_GPIOH);
    MAP_SysCtlPeripheralSleepEnable(SYSCTL_PERIPH_UART0);
    MAP_SysCtlPeripheralSleepEnable(SYSCTL_PERIPH_I2C7);
