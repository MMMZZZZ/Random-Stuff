...
//*****************************************************************************
//
//! \addtogroup eth_client_lwip_api
//! @{
//
//*****************************************************************************
...
//!
//! \return This functions returns a '0' if successful, or a '1' if an error
...
//!
//! \return This function always returns ERR_OK.
//
//*****************************************************************************
err_t
...
//! \param ui16Port is the string used as the proxy port.
//!
...
//!
//! \param pcHostName is the string used as the host server name.
//! \param ui16Port is the string used as the host port.
//!
//! This function sets the current host used by the Ethernet connection.  The
//! \e pcHostName value can be 0 to indicate that no host is in use or it can
//! be a pointer to a string that holds the name of the host server to use.
//! The content of the pointer passed to \e pcHostName should not be changed
//! after this call as this function only stores the pointer and does not copy
//! the data from this pointer.
//!
//! \return None.
...
//!
//! \param ui32SysClock is the input for the system clock setting of the TM4C
//! \param pfnEvent is the network event handler.
//!
