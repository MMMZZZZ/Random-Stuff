//*****************************************************************************
//
// hibernate_calendar.c - Hibernation Example.
//
...
//! <h1>Hibernate Calendar Mode Example (hibernate_calendar)</h1>
//!
...
main(void)
{
    ...
    if(HibernateIsActive())
    {
        ...
        {
            MAP_HibernateDataGet(&ui32HibernateCount, 1);
        }
    }
    ...
    //
    MAP_GPIOPadConfigSet(GPIO_PORTK_BASE, GPIO_PIN_6, GPIO_STRENGTH_2MA,
    ...
    //
    MAP_SysTickPeriodSet(SysCtlClockGet() / 30);
    MAP_SysTickEnable();
    ...
    while(1)
    {
        ...
        if(g_bHibernate == true)
        {
            ...
            //
            ui32HibernateCount++;
            MAP_HibernateDataSet(&ui32HibernateCount, 1);
