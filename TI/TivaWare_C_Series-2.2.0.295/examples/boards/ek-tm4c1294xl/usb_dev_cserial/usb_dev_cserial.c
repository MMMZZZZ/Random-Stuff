...
//! serial device provided by the TM4C controller.
//!
//! The second TM4C virtual serial port will provide a console that can
//! echo data to both the ICDI virtual serial port and the first TM4C
...
//
//****************************************************************************
#define LEDOn()  MAP_GPIOPinWrite(CLP_D1_PORT, CLP_D1_PIN, CLP_D1_PIN);

#define LEDOff() MAP_GPIOPinWrite(CLP_D1_PORT, CLP_D1_PIN, 0)
#define LEDToggle()                                                         \
        MAP_GPIOPinWrite(CLP_D1_PORT, CLP_D1_PIN,                           \
                         (MAP_GPIOPinRead(CLP_D1_PORT, CLP_D1_PIN) ^        \
                          CLP_D1_PIN));
